		...
		<div class="container">
			...
			<div class="container"> 
				 <form class="form-inline" action="jsp03.jsp">
			     		<button type="submit" class="btn btn-warning">Retorna para outra Montadora dessa Categoria </button>
			  	</form>
			</div>
			...
			<div class="container"> 
			 ...
			 <hr>
		 	  ...
		 	  <div 
	    	  		...
	    	  		<p><%out.print("<h5>Categoria: <b>" + session.getAttribute("nomeCategoriaEscolhida") + "</h5></b>");%>
	    	  		<p><%out.print("<h5>Montadora: <b>" + session.getAttribute("nomeMontadoraEscolhida") + "</h5></b>");%>
	   		  </div>
					...
					<table class="table table-sm">
					   <thead>
						    <tr>
						      ...
						      <th scope="col">Mercado Paralelo</th>
						    </tr>
						</thead>
			
  						<tbody>
							<%
								ArrayList<ResultJoin> listagemItens = 
									(ArrayList<ResultJoin>) session.getAttribute("listagemItens");
								int n = listagemItens.size();
								for (int i=0 ; i < n; i++) {
									 out.print("<tr>");	
									 out.print("<td><p>" + listagemItens.get(i).getDescmontadora() +"</td>");
									 out.print("<td><p>" + listagemItens.get(i).getCodproduto() +"</td>");
									 out.print("<td><p>" + listagemItens.get(i).getCoditem() +"</td>");
									 out.print("<td><p>" + listagemItens.get(i).getDescitem()  +"</td>");
									 out.print("<td><p>" + listagemItens.get(i).getMercadoparalelo() +"</td>");
									 out.print("</tr>");	
								}
							%>
			  	   		</tbody>
