...
<body>
	...
	<div class="jumbotron jumbotron-fluid">
		<div class="container">
			...
			<h1>USCS - Escola Politécnica - Consulta dados de Alunos Ativos</h1>
			<hr>
			...
			<form class="form-inline" action="controller01" method="post" >
  				...
  				<input type="text" class="form-control mb-2 mr-sm-2" placeholder="Digite aqui" id="codaluno" name="codaluno" required>
